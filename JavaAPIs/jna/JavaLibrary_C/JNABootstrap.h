...
char* CUSTOM_LIB = (char* )"F:/Docs2023/ProgrammingLanguageDesignation/newLanguage1/final/language/CAiml/Phases/ImplementationsProposals/ImplementedOnCpp/GitHub/CAiml/JavaAPIs/jna/JavaLibrary/build/classes";

// Paths to the JNA components
char* JNA_LIB = (char* )"F:/Docs2023/ProgrammingLanguageDesignation/newLanguage1/final/language/CAiml/Phases/ImplementationsProposals/ImplementedOnCpp/GitHub/CAiml/JavaAPIs/jna/JavaLibrary_JNA/dist/lib/jna-4.2.2.jar";
char* JNA_PLATFORM_LIB = (char* )"F:/Docs2023/ProgrammingLanguageDesignation/newLanguage1/final/language/CAiml/Phases/ImplementationsProposals/ImplementedOnCpp/GitHub/CAiml/JavaAPIs/jna/JavaLibrary_JNA/dist/lib/jna-platform-4.2.2.ja";

// Path to the native version of the library
char* CUSTOM_C_LIB = (char* )"F:/Docs2023/ProgrammingLanguageDesignation/newLanguage1/final/language/CAiml/Phases/ImplementationsProposals/ImplementedOnCpp/GitHub/CAiml/JavaAPIs/jna/JavaLibrary_C/dist/Debug/GNU-MacOSX";
...
//char* JAVA_LIB = (char*)"C:/Program Files/Java/jdk1.8.0_202/jre/lib";
//char* JLI_LIB = (char*)"";
...
JNIEnv* create_vm(JavaVM ** jvm, char* classname) {
    ...
    printf("Creating the JVM with classpath=%s/n", options.optionString);
    int ret = JNI_CreateJavaVM(jvm, (void**)&env, &vm_args);
    if ( ret < 0 ) {
        printf( "--Unable to Launch JVM/n" );
        return NULL;
    }

    //char* classname = (char* )"javalibrary_jna/JavaLibrary_JNA";
    printf("Looking for %s/n", classname);
    jclass cls = env->FindClass(classname);
    if ( ! cls ) {
        printf( "--Could not load %s/n", classname );
        return NULL;
    }
    
    printf("Getting main/n");
    jmethodID main_method = env->GetStaticMethodID(cls, "main", "([Ljava/lang/String;)V");
    if ( ! main_method ) {
        printf("--main_method is null!/n");
        return NULL;
    }

    printf("Getting constructor/n");
    jmethodID constructor = env->GetMethodID(cls, "<init>", "()V");
    if ( ! constructor ) {
        printf("--Could not load constructor/n");
        return NULL;
    }
    printf("--------------------------------------/n");
